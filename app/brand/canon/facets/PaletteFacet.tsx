  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-center justify-between">
        ...
        <button type="button" className="btn-secondary btn-xxs" onClick={addColor}>
          Add color
        </button>
      </div>
      ...
      <div className="flex flex-col gap-2">
        {draft.palette.map((color, i) => (
          <div key={i} className="flex items-center gap-2 bg-surface-mid border border-line rounded-md p-2">
            <input
              type="color"
