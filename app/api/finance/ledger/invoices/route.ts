  ...
  let query = supabase
    ...
    .select(`
      *,
      ...
      invoice_line_items( id, sort_order, description, category, quantity, unit_price_cents, total_cents, variation_name, chart_of_accounts_id, chart_of_accounts( id, account_name, account_number, account_type ) ),
