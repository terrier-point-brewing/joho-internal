  ...
  let query = supabase
    ...
    .select(`
      *,
      ...
      invoice_line_items!invoice_line_items_invoice_id_fkey( id, sort_order, description, category, quantity, unit_price_cents, total_cents, variation_name, chart_of_accounts_id, bs_chart_of_accounts_id, pl_chart_of_accounts_id, delivery_invoice_id, account_mode, chart_of_accounts!invoice_line_items_chart_of_accounts_id_fkey( id, account_name, account_number, account_type ) ),
