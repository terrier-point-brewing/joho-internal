...
export const LEGACY_MATRIX: LegacyRow[] = [
  ...
  { route: "brand/assets/[id]", method: "PATCH", legacy: [], capability: "brandWorkbenchManage" },
  { route: "brand/assets", method: "GET", legacy: [], capability: "brandWorkbenchRead" },
  { route: "brand/assets", method: "POST", legacy: [], capability: "brandWorkbenchManage" },
  ...
  { route: "brand/chrome", method: "PUT", legacy: [], capability: "brandGuideManage" },
  { route: "brand/labels/[id]", method: "GET", legacy: [], capability: "brandWorkbenchRead" },
  { route: "brand/labels/[id]", method: "PATCH", legacy: [], capability: "brandWorkbenchManage" },
  { route: "brand/labels", method: "GET", legacy: [], capability: "brandWorkbenchRead" },
  { route: "brand/labels", method: "POST", legacy: [], capability: "brandWorkbenchManage" },
  ...
  { route: "production/export-settings/excise-tax-rates", method: "GET", legacy: ["viewer", "brewer", "manager"], capability: "productionSettingsRead", intentionalChange: { viewer: false, reason: "API-only; app/production/layout.tsx already redirects viewers" } },
  ...
  { route: "production/recipe-square-link-ignores", method: "POST", legacy: ["brewer", "manager"], capability: "productionSettingsOperate" },
  { route: "production/recipe-square-link-ignores", method: "DELETE", legacy: ["brewer", "manager"], capability: "productionSettingsOperate" },
  { route: "production/recipe-square-links", method: "POST", legacy: ["brewer", "manager"], capability: "productionSettingsOperate" },
  { route: "production/recipe-square-links", method: "DELETE", legacy: ["brewer", "manager"], capability: "productionSettingsOperate" },
  ...
  { route: "tax/tasks/[id]/complete", method: "POST", legacy: ["manager"], capability: "taxOperate" },
  { route: "tax/tasks/[id]/files/[fileId]", method: "GET", legacy: ["manager"], capability: "taxRead" },
  { route: "tax/tasks/[id]/files/[fileId]", method: "DELETE", legacy: ["manager"], capability: "taxOperate" },
  { route: "tax/tasks/[id]/files", method: "POST", legacy: ["manager"], capability: "taxOperate" },
  { route: "tax/tasks/[id]/files", method: "GET", legacy: ["manager"], capability: "taxRead" },
  { route: "tax/tasks/[id]/recompute", method: "POST", legacy: ["manager"], capability: "taxOperate" },
  { route: "tax/tasks/[id]", method: "GET", legacy: ["manager"], capability: "taxRead" },
  { route: "tax/tasks/[id]", method: "PATCH", legacy: ["manager"], capability: "taxOperate" },
